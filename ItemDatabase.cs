...
namespace WindroseEditor
{
    ...
    public class ItemEntry
    {
        ...
        /// <summary>
        /// Дополнительные слоты инвентаря, которые добавляет этот рюкзак.
        /// 0 для всех не-рюкзачных предметов. Заполняется из DB v3+.
        /// </summary>
    ...
    public static class ItemDatabase
    {
        ...
        /// <summary>Версия схемы загруженной базы (1/2/3). 0 — не загружена или HTML.</summary>
